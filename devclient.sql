...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 02, 2022 at 12:08 AM
...
CREATE TABLE IF NOT EXISTS `cosmetics` (
  ...
  `hat_color_r` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `hat_color_g` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `hat_color_b` tinyint UNSIGNED NOT NULL DEFAULT '0',
